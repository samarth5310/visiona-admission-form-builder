...
import { User, BookOpen, GraduationCap, CreditCard, Home, LogOut, Gamepad2, Menu, X } from 'lucide-react';
...
const StudentSidebar = ({ activeSection, onSectionChange }: StudentSidebarProps) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed lg:relative top-0 left-0 h-full w-64 bg-white shadow-lg border-r z-40 transform transition-transform duration-300 ease-in-out
