    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-2 sm:px-4 lg:px-6">
        <div className="max-w-4xl mx-auto py-4 sm:py-6 bg-white border-2 sm:border-4 border-gray-300 rounded-lg shadow-lg">
          ...
          <div className="text-center border-b-2 border-gray-500 pb-4 sm:pb-6 mb-6 sm:mb-8 rounded-lg p-3 sm:p-6 mx-2 sm:mx-0 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-4">
              <img 
                ...
                className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 object-contain bg-white rounded-full p-2" 
              />
              <div className="text-center">
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2">VISIONA EDUCATION ACADEMY</h1>
                <p className="text-sm sm:text-base lg:text-lg text-blue-100">Coaching Centre for 3rd-5th Standard Competitive Exams</p>
                <p className="text-xs sm:text-sm text-blue-200">Navodaya | Sainik | Morarji | Kittur | Alvas</p>
                <p className="text-xs sm:text-sm text-blue-200 font-medium mt-1">16th Cross Vidyagiri Bagalkot</p>
              </div>
            </div>
          </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-gray-50 p-3 sm:p-6 rounded-lg border">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <FormField control={form.control} name="lastYearPercentage" render={({ field }) => (
                      <FormItem>
                    ...
                    <FormField control={form.control} name="subjectsWeakIn" render={({ field }) => (
                      <FormItem className="sm:col-span-2">
                    ...
                    <FormField control={form.control} name="examsPreparingFor" render={({ field }) => (
                      <FormItem className="sm:col-span-2">
