...
const StudentDashboard = () => {
  ...
  const leftMenuItems = [
    ...
    { label: 'Homework', path: '/student-dashboard' },
    { label: 'Marks', path: '/student-dashboard' },
    { label: 'Fees', path: '/student-dashboard' },
    { label: 'Games', path: '/student-dashboard' },
  ];

  const rightMenuItems = [
    { label: 'Dashboard', path: '/student-dashboard' },
    { label: 'Help', path: '/student-dashboard' },
    { 
      label: 'Back to Home', 
      path: '/',
  ...
  return (
    <div className="min-h-screen bg-black font-roboto">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 sm:p-6 border border-blue-100 mb-6">
